...
class TestEventsRegistration:
    ...
    @pytest.mark.skip
    @pytest.mark.parametrize("TC_ID", ["TC_E_003"], indirect=True)
    ...
    @pytest.mark.parametrize("TC_ID", ["TC_E_005"], indirect=True)
    def test_event_registration_switch_to_standard(
        self, TC_ID, driver, login_flow, events_flow, logout_flow
    ):
        login_flow.verify_home()
