...
class AccountPage(AndroidBasePage):
    ...
    def verify_screen(self):
        ...
        self.capture_step("account_screen")
    ...
    def tap_edit_personal_info(self):
        ...
        self.capture_step("edit_personal_info")
    ...
    def open_delete_account(self):
        ...
        self.capture_step("delete_account")
    ...
    def open_privacy_policy(self):
        ...
        self.capture_step("privacy_policy")

    # --- log out ---
    def tap_log_out(self):
        self.click(L.button_log_out)
        self.capture_step("log_out")
