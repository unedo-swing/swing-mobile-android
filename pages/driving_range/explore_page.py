...
class DrivingRangeExplorePage(AndroidBasePage):
    ...
    def verify_screen(self):
        ...
        self.capture_step("driving_range_explore")
    ...
    def verify_results_loaded(self):
        ...
        self.capture_step("dr_results_loaded")

    # ================= header / search =================
    def tap_back(self):
        self.click(L.button_back)
        self.capture_step("dr_back")

    def tap_search(self):
        self.click(L.search_bar)
        self.capture_step("dr_search")
    ...
    def verify_recent_searches(self):
        ...
        self.capture_step("dr_recent_searches")
    ...
    def toggle_swing_pass_partners(self):
        ...
        self.capture_step("dr_toggle_swing_pass")
